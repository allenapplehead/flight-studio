    ...
    <div class="w-full h-auto overflow-scroll block h-screen bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 p-4 flex items-center justify-center">
      <div class="bg-white py-6 px-10 sm:max-w-md w-full ">
        ...
        <div class="">
          ...
          <div class="flex">
            <input type="checkbox" class="border-sky-400 " onChange={handleTerms} value={inputTerms} required/>
            <div class="px-3 text-gray-500">I accept the <a href="">Terms & Conditions</a></div>
          </div>
          <div class="flex justify-center my-6">
            <button class=" rounded-full  p-3 w-full sm:w-56   bg-gradient-to-r from-sky-600  to-teal-300 text-white text-lg font-semibold " onClick={handleSubmit}>
              Create Account
            </button>
          </div>
          <div class="flex justify-center ">
            <p class="text-gray-500">Already have an account? </p>
            <a class="text-sky-600 pl-2">
              Sign In
            </a>
          </div>
        </div>
